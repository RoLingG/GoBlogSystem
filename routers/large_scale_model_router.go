...
func (router RouterGroup) LargeScaleModelRouter() {
	...
	// 配置相关路由
	{
		...
		router.PUT("/large_scale_model/session_setting", middleware.JwtAdmin(), largeScaleModelApi.ModelSessionSettingUpdateView) //大模型会话更新接口
	...
	//大模型角色相关路由
	{
		...
		router.GET("/large_scale_model/role", middleware.JwtAdmin(), largeScaleModelApi.ModelRoleListView)                       //大模型角色列表获取接口
		router.DELETE("/large_scale_model/role", middleware.JwtAdmin(), largeScaleModelApi.ModelRoleDeleteView)                  //大模型角色删除接口
		router.GET("/large_scale_model/role_tag", middleware.JwtAdmin(), largeScaleModelApi.LargeScaleModelRoleTagListView)      //大模型角色广场接口
		router.GET("/large_scale_model/role_info/:id", middleware.JwtAuth(), largeScaleModelApi.ModelRoleInfoView)               //大模型角色信息详情接口
		router.GET("/large_scale_model/role_icon/options", middleware.JwtAdmin(), largeScaleModelApi.ModelRoleIconsView)         //大模型角色头像获取接口
	}
	...
	//大模型会话相关路由
	{
		...
		router.DELETE("/large_scale_model/session", middleware.JwtAuth(), largeScaleModelApi.ModelSessionDeleteView)                 //大模型会话删除接口
